...
<section class="container mx-auto">
  <div class="flex flex-wrap -mx-4">
    <div class="w-full px-4 mb-4 md:w-4/12 md:mb-0">
      <h3 class="font-semibold mb-4">My Category</h3>
      <ul>
        <li class="mb-2"><a href="{{ route('catalog') }}" class="text">All</a></li>
        @foreach ($categories as $category)
        <li class="mb-2"><a href="{{ route('catalog', ['category'=> $category->id]) }}" class="text">{{ $category->name }}</a></li>
        @endforeach
      </ul>
    </div>
    <div class="w-full px-4 mb-4 md:w-8/12 md:mb-0">
      ...
      <div class="flex -mx-4 flex-wrap relative">
        ...
        <div class="px-4 relative card group w-6/12 md:w-3/12" style="margin-bottom: 100px">
          <div
